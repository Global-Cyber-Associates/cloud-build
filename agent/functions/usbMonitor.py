...
EJECT_DELAY = 3  # seconds before ejecting blocked USB 
kernel32 = ctypes.WinDLL("kernel32", use_last_error=True) 
 
# ------------------------------------------------------------ 
# CACHE MANAGEMENT (with timestamp) 
# ------------------------------------------------------------ 
# Format: { "SERIAL": {"status": "Allowed"/"Blocked"/"Pending", "timestamp": epoch_seconds} } 
usb_cache = {} 
...
def monitor_usb(interval=3, timeout=6): 
    ...
    while True: 
        try: 
            ...
            # STEP 1: add new devices as Pending 
            for usb in devices: 
